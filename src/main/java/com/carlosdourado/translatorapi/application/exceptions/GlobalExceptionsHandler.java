...
public class GlobalExceptionsHandler {
    ...
    @ExceptionHandler(BlankOrNullParametersException.class)
    public ResponseEntity<ErrorResponse> handleBlankOrNullParameters(BlankOrNullParametersException ex){
        return buildErrorResponse(HttpStatus.BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler(CsvReadException.class)
    public ResponseEntity<ErrorResponse> handleCsvRead(CsvReadException ex){
        return buildErrorResponse(HttpStatus.BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler(CredentialsNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleCrentialsNotFound(CredentialsNotFoundException ex){
        return buildErrorResponse(HttpStatus.UNAUTHORIZED, ex.getMessage());
    }
